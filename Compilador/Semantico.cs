...
namespace Compilador
{
    public class Semantico
    {
        ...
        public void ejecutarSemantico(List<Token> listaTokensSemantico) { 
            int i;
        ...
        public void AgregarVariable(LinkedList<Variables> listaDeVariables, int puntero) {
            ...
            if (listaDeVariables.Count != 0) {
                for (int contador = 1; contador <= nodos; contador++) {
                    if (listaTokensSemantico[puntero + 1].Lexema != listaDeVariablesAuxiliar[posicionListaAuxiliar].Lexema ) {
                        if (contador == nodos) {
                            listaDeVariables.AddLast(new Variables { Tipo = tempTipo, Lexema = listaTokensSemantico[puntero + 1].Lexema });
                        }
                        else {
        ...
        public void ValidacionDeTiposRelacional(LinkedList<Variables> listaDeVariables, int puntero) {
            List<Variables> listaDeVariablesAuxiliar = listaDeVariables.ToList();
            int nodos = listaDeVariablesAuxiliar.Count;
            ...
            do {
                expresionCondicionalEnInfijo.Add(new Variables { Tipo = listaTokensSemantico[punteroDeCondicional + 1].TipoToken.ToString(),
